...
import { auth, db } from '../../firebase.config'; // আপনার কনফিগারেশন ফাইল
...
const SignInWithGoogle = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // এখানে লগইন সফল হওয়ার পর কোনো পেইজে রিডাইরেক্ট করতে পারেন
            // navigate('/');
    ...
    return (
        <button
            ...
            type="button"
            className="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition duration-300"
        >
            {/* Google Icon SVG */}
