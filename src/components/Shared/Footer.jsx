        ...
        <footer className="bg-slate-800 text-gray-300">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <Link to="/" className="flex items-center space-x-3">
                            ...
                            <span className="font-black text-2xl text-white">RentTime</span>
                        </Link>
                        <p className="text-sm text-gray-400">
                            The easiest way to find your next home or roommate in Bangladesh.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            ...
                            <li><Link to="/house" className="text-base text-gray-400 hover:text-white transition-colors">Find a House</Link></li>
                            <li><Link to="/roommate" className="text-base text-gray-400 hover:text-white transition-colors">Find a Roommate</Link></li>
                            <li><Link to="/blog" className="text-base text-gray-400 hover:text-white transition-colors">Blog</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            ...
                            <li><Link to="/privacy-policy" className="text-base text-gray-400 hover:text-white transition-colors">Privacy Policy</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-base text-gray-400">
                            <li className="flex items-start"><span className="mt-1 mr-2">&#128205;</span><span>Dhaka, Bangladesh</span></li>
                            <li className="flex items-center"><span className="mr-2">&#9742;</span><a href="tel:+8801234567890" className="hover:text-white">+880 123 4567890</a></li>
                            <li className="flex items-center"><span className="mr-2">&#9993;</span><a href="mailto:support@renttime.com" className="hover:text-white">support@renttime.com</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
                    <p>&copy; {new Date().getFullYear()} RentTime. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
